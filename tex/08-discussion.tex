\section{Discussion and Outlook}
  ...
  \subsection{Scope of the Mechanism}
    ...
    It affects only the quantitative $T_c$ estimates of Section~\ref{sec:nickelates} and
    Appendix~\ref{app:nickelate_Tc}, which should be understood as order-of-magnitude predictions rather than precision
    calculations.
